...
class Board:
    ...
    physical_board: bool
    """
    physical_board is True for:
        ├── stm32   66
        │   ├── ADAFRUIT_F405_EXPRESS 
        │   ├── ARDUINO_GIGA 
        │   ├── PYBV11  DP, DP_THREAD, NETWORK, THREAD

    physical_board is False for:
        ├── unix   1
        │   └── unix  minimal, coverage, standard, nanbox
        ├── webassembly   1
        │   └── webassembly  standard, pyscript
        └── windows   1
            └── windows  dev, standard
    """
