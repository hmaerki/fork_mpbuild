...
def build_by_variant(variant: Variant, do_clean: bool) -> Firmware:
    """ """
    ...
    return Firmware(filename=filename, variant=variant, micropython_version_text=None)


def build_by_variant_str(db: Database, variant_str: str, do_clean: bool) -> Firmware:
    """
    This will build the firmware and return its path.
